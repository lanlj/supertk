<?php
define ('VERSION', '1.0.0');																		// Version of this script 
...
if(! defined('FILE_CACHE_PREFIX') ) 		define ('FILE_CACHE_PREFIX', 'thumb');				// What to put at the beg of all files in the cache directory so we can identify them
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', './upload/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
class timthumb {
	...
	protected function cleanCache(){
		...
		$lastCleanFile = $this->cacheDirectory . '/timthumb.touch';
